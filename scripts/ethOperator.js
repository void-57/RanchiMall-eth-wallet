(function (EXPORTS) {
  ...
  const getTransactionHistory = (ethOperator.getTransactionHistory = async (
    address
  ) => {
    const url =
  ...
  const getTransactionDetails = (ethOperator.getTransactionDetails =
  ...
  const getTokenBalance = (ethOperator.getTokenBalance = async (
    address,
    token,
    { contractAddress } = {}
  ) => {
  ...
  const sendTransaction = (ethOperator.sendTransaction = async ({
    privateKey,
    receiver,
    amount,
  }) => {
  ...
  const sendToken = (ethOperator.sendToken = async ({
    token,
    privateKey,
    amount,
    receiver,
